        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">ISTE Student Chapter,<br> TKM College Of Engineering, Kollam, Kerala - 691005</p>

              <!-- <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">+1 232 3235 324</a></p> -->

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">mail@istetkmce.in</a></p>
  ...
  <script>
    ...
    if (success == 'true') {
      ...
      Swal.fire({
        type: 'error',
        title: 'Oops...',
        text: 'Some error occured. Try mailing us at mail@istetkmce.in'
      });
    }
  </script>
