...
$sql ="SELECT name,phone FROM `user` WHERE email=:email and phone=:password";
...
<link rel="icon" href="admin/images/GEARFINAL.png" type="image/icon type">
    <title>Login | ISTE Students Panel</title>
                            ...
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" onclick="window.location.href='https://api.whatsapp.com/send?phone=919961957849&text=CHANGE MY PASSWORD?'">FORGOT PASSWORD </button>
                                   </div>
                                </div>
