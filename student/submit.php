...
$sql ="INSERT INTO `user_newsletter` (name, email, phone, branch, batch, year, link) VALUES(:name, :email, :phone, :branch, :batch, :year, :link)";
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="m-b-10">
                                                    ...
                                                    <div class="row">
                                                    <label style="text-align:right;" class="col-sm-6 col-form-label">Newsletter</label>
