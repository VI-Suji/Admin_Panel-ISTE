...
$sql ="SELECT `password` FROM `user` WHERE `name`=:username and `password`=:current";
...
{
    if($newpass==$repass){
$con="UPDATE user set password=:newpass where name=:username";
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="m-b-10">
                                                ...
                                                <div class="row">
                                                    <label class="col-sm-4 col-lg-6 col-form-label">Current
                                                        Password</label>
                                                    <div class="col-sm-8 col-lg-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password" name="curr" class="form-control">
                                                        </div>
                                                    </div>

                                                </div>
                                                <div class="row">
                                                    <label class="col-sm-4 col-lg-6 col-form-label">Enter new
                                                        password</label>
                                                    <div class="col-sm-8 col-lg-6">
                                                        <div class="input-group">
                                                            <span class="input-group-prepend">
                                                ...
                                                <div class="row">
                                                    <label class="col-sm-4 col-lg-6 col-form-label">Re-Enter the
                                                        password</label>
                                                    <div class="col-sm-8 col-lg-6">
                                                        <div class="input-group">
                                                            <span class="input-group-prepend">
