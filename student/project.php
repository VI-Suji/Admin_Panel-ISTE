...
$sql ="INSERT INTO `project` (name, email, phone, branch, batch, year, requirement, link) VALUES(:name, :email, :phone, :branch, :batch, :year, :require, :link)";
...
$query-> bindParam(':require', $require, PDO::PARAM_STR);
        ...
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    ...
                    <span>Request for project development ISTE form</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="m-b-10">
                            ...
                            <div class="row">
                                <label
                                    class="col-sm-4 col-lg-1 col-form-label">Require</label>
                                <div class="col-sm-8 col-lg-5">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text">#</label>
                                        ...
                                        <select name="require" class="form-control">
                                            <option name="guidance" value="guidance">Guidance
                                            </option>
                                            <option name="working members" value="working">Working
                                                Members</option>
                                        </select>
                                    </div>
                                </div>
                                <label class="col-sm-1 col-form-label">Abstract(link)</label>
                                <div class="col-sm-8 col-lg-5">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text">#</label>
