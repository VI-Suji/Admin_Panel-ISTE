        ...
        <div class="media-with-text">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img style="width:250px; height:250px;" src="./admin/images/<?php echo htmlentities($result->image) ?>" alt="" class="img-fluid img-round"/>
                </a>
              </div>
              <center>
                <h2 class="heading mb-0"><a href="#"><?php echo htmlentities($result->name) ?></a></h2>
                <span class="mb-3 d-block post-date"><a href="#"><?php echo htmlentities($result->position) ?></a></span>
              </center>
